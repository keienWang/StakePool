...
contract DssExec {
    ...
    Changelog      constant public log   = Changelog(0x6Ad4513Bd500248FF5F3d11199Fe85b33bcFaDDc);
    uint256                 public eta;
    bytes                   public sig;
    bool                    public done;
...
contract DssSpellAction is DssAction {
    ...
    //address constant MCD_JOIN_BUSD_Y = 0xBD9167f433Ba8873D0B4ac0EAfA4A1F762ff985f;
    //address constant MCD_FLIP_BUSD_Y = 0xF97f9AD2D0E2DB1b2e3A313e9e2CdBa9bB1EF316;
    
    address constant MCD_JOIN_BUSD_V = 0x01D602E21e1c7256e24d71709798352a04Ec621c;
    address constant MCD_FLIP_BUSD_V = 0xf52E1275455C1a2B65ae5235F1Fa708477De1730;
    ...
    function actions() public override {
        // Rates Proposal
        // DssExecLib.setIlkStabilityFee("BUSD-A", FOUR_PT_FIVE_PCT, true);
        /**
        // Onboarding ETH-C
        CollateralOpts memory BUSD_V = CollateralOpts({
            ilk: "BUSD-V",
            gem: DssExecLib.getChangelogAddress("BUSD"),
            join: MCD_JOIN_BUSD_V,
            flip: MCD_FLIP_BUSD_V,
            pip: DssExecLib.getChangelogAddress("PIP_BUSD"),
            isLiquidatable: true,
            isOSM: true,
            whitelistOSM: false,
            ilkDebtCeiling: 165 * MILLION,
            minVaultAmount: 1,
            maxLiquidationAmount: 50000,
            liquidationPenalty: 1300,
            ilkStabilityFee: SIX_PCT,
            bidIncrease: 300,
            bidDuration: 2 minutes,
            auctionDuration: 2 minutes,
            liquidationRatio: 12500,
            tokenFirstAdd: false
        });
        addNewCollateral(BUSD_V);
        //DssExecLib.setIlkAutoLineParameters("ETH-C", 2000 * MILLION, 100 * MILLION, 12 hours);
        
        //DssExecLib.setIlkDebtCeiling("BUSD-A", 29 * MILLION);
        
        //DssExecLib.setGlobalDebtCeiling(800 * MILLION);
        
        DssExecLib.setIlkDebtCeiling("BUSD-A", 2);
        
        DssExecLib.setChangelogAddress("MCD_JOIN_BUSD_V", MCD_JOIN_BUSD_V);
        DssExecLib.setChangelogAddress("MCD_FLIP_BUSD_V", MCD_FLIP_BUSD_V);

        // bump changelog version
        DssExecLib.setChangelogVersion("1.0.3");
        **/
        
        //DssExecLib.setPauseDelay(25);
        
        //change pip.hop to 10 seconds
        OracleLike_2(0xd3Da8963D75c23710C5cF087b755ED69BBeA98ec).step(60);
        
        //pip.change src
        //OracleLike_2(0xd3Da8963D75c23710C5cF087b755ED69BBeA98ec).change(0xCD046a54918F61a1802ef6f9A7B5e226c8C34B61);
        
        //flipper.rely
        // Authorizable(0xcbfD5787fC6ABB8dA05F78c88fFCc8F05cbd0B36).rely(0x2f36477632f6C0830203140BEEA7107d4258F595);
    }
}
